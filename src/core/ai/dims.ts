...
export function dimsProviderOptions(
  ...
  switch (implementation) {
    ...
    case 'openai-compatible':
      ...
      // DashScope text-embedding-v3 (Matryoshka 64-1024) / v4 (64-2048)
      // and Zhipu embedding-3 (Matryoshka 256-2048) all accept `dimensions`
      // on the OpenAI-compat path. Without this, user-selected non-default
      // dims are silently ignored and the provider returns its default size.
