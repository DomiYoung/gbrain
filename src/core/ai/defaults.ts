...
// Domi fork default: Domi's production GBrain is standardized on DashScope
// text-embedding-v4 at 1536 dimensions. Keep defaults aligned with runtime
// config so chunk upserts do not rewrite content_chunks.model back to
