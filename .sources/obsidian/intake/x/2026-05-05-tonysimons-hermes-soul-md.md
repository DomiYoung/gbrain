...
engagement:
  ...
  thread_replies: 41
  unique_authors: 26
  thread_total_likes: 1022
  thread_total_retweets: 82
captured_at: '2026-06-16T03:56:34.169Z'
source_type: x
captured_via: capture-cli
ingested_via: put_page
ingested_at: '2026-06-16T03:56:35.527Z'
...
**Bio:** AI agent builder. | @NousResearch Hermes Agent + @OpenAI Codex obsessive. | Shipping open-source tools, AI art, and automation experiments in public.
...
| Metric | Value |
|--------|-------|
| Original tweet likes | 972 |
| Original tweet retweets | 82 |
| Total thread likes | 1022 |
| Total thread retweets | 82 |
| Reply count | 41 |
| Unique participants | 26 |

## Key Discussion Themes

### SOUL.md Requests & Discussion
Multiple users asked to see the actual SOUL.md file:
- @chefamysins: "It would be amazing if you actually posted your soul.md"
- @agentmith: "Do you have your SOUL.md posted anywhere? Mine's just not working"
- @JakomJakababa: "Can we see the actual soul.md?"
- @AbyssDigest: "Where is link to soul.md that we can take it as template"
- @kextcache: "I'm more intrigued to view your soul.md now"

### Technical Comparisons
- @Gaurav_vij137 asked about Claude Code vs Hermes with SOUL.md
- @tonysimons_ responded: "Claude = walled garden, locked down OS... Other agents, especially Hermes: open source with total transparency"
- @subtlemusing noted: "soul md files are a core feature in paperclip too"

### Community Reception
- @aisama_code: "this is the pattern most agent setups miss. not more tools. clearer operating contract"
- @navidamu: "Wow, I just implemented that, & Hermes is totally different & a lot less wishy-washy"
- @nakadai_mon: "The soul is the lens the agent uses throughout all the work it's doing"
- @SouthLiPeace1: "describe agent as the friend you need. your buddy"
- @klass_room_: "One of the most useful pieces I have read in some time"
...
> "Proactive output is the baseline, but it's not enough. If Tony isn't acting on what you surface, the feedback loop is broken."

> "Never without Tony's explicit approval: posting, publishing, purchasing, or making destructive changes that can't be reversed. Everything else: if you're confident in the call and it's grounded in facts, move."
