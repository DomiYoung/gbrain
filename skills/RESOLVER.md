...
| "install gbrain", "setup gbrain", "bootstrap brain", "initialize brain" | `skills/install/SKILL.md` |
| "loop engineering", "boris cherny", "write loops", "loop design", "maker checker loop" | `skills/loop-engineering/SKILL.md` |
| "unified search", "5-layer search", "global search", "multi-source retrieval" | `skills/unified-search/SKILL.md` |
