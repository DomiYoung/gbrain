...
Generated: 20260616T154926Z

## Summary

| Metric | Count |
|---|---:|
| Dry-run drift candidates | 586 |
| Safe to move: no target row | 5 |
| Not safe without review: soft-deleted target collision | 189 |
| Not safe: active target collision | 392 |

## Artifacts

| Artifact | Path |
|---|---|
| Candidate CSV | `/Users/light/gbrain/tmp/default-source-drift-repair/default_source_drift_dry_run_20260616T154926Z.csv` |
| Review SQL | `/Users/light/gbrain/tmp/default-source-drift-repair/default_source_drift_repair_20260616T154926Z.sql` |
| Rollback SQL | `/Users/light/gbrain/tmp/default-source-drift-repair/default_source_drift_rollback_20260616T154926Z.sql` |

## Backup command

```bash
pg_dump --format=custom --file=/Users/light/gbrain/tmp/default-source-drift-repair/gbrain_custom_clean_before_default_drift_20260616T154926Z.dump "$GBRAIN_DATABASE_URL"
```
